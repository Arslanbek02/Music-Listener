...
<template>
 <!-- Registration Form -->
          ...
          <vee-form :validation-schema="schema"
            ...
            <!-- Email -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="email-reg">Email</label>
            ...
            <!-- Password -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="passwrod-reg">Password</label>
            ...
            <!-- Confirm Password -->
            <div class="mb-3">
              <label class="inline-block mb-2" for="password-confirm">Confirm Password</label>
            ...
            <div class="mb-3 pl-6">
              ...
              <label class="inline-block" for="check">Accept terms of service </label>
